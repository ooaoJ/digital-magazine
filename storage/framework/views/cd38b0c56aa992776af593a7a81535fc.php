...
<body data-bs-theme="dark" class="h-100 d-flex align-items-center justify-content-center flex-column">
    ...
    <div class="d-flex gap-2">
        <a class="btn btn-primary" href="<?php echo e(route('login')); ?>">Ir para o login</a>
        <a class="btn btn-primary" href="<?php echo e(route('register')); ?>">Ir para o registro</a>
    </div>
...
</html><?php /**PATH C:\Users\47814267862\Desktop\revista\resources\views/welcome.blade.php ENDPATH**/ ?>